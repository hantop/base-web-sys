  ...
  <div class="workedit-scheme">
    ...
    <div >
      ...
      <div class='common-group'>
        ...
        <el-form label-position='top' :model='save' :inline='true' ref='save'>
          <el-row>
          ...
          <el-row>
            <el-form-item label='费用方案'  :rules='$rules.requiredInputFigure'>
              <el-radio-group v-model="save.feeplanId">
                <el-radio :label="feeplanId1">默认方案</el-radio>
                <el-radio :label="feeplanId2">管理费方案</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label='费率（%）'  prop='projectRate' v-if="save.feeplanId == 1 " :rules='$rules.requiredInputFigure'>
            ...
            <el-form-item label='费率（%/月）'  prop='projectRate' v-if="save.feeplanId == 2" :rules='$rules.requiredInputFigure'>
              ...
              <el-form-item label='管理费率（%）'  prop='managementRate' v-if="save.feeplanId == 2" :rules='$rules.requiredInputFigure'>
          ...
          <el-row>
            <el-form-item label='还款方式' :rules='$rules.requiredInputNumber' prop='paymentplanId'>
            ...
            <el-form-item label='担保方式'  :rules='$rules.requiredInputNumber' >
    ...
    methods: {
      ...
      getqueryCustomerInfo() {
        customerController
          ...
          .then(res => {
            ...
            console.info(this.customerId ,890808080800)
            ...
            this.save ={
              ...res.data.order,
              ...this.$route.query,
               feeplanId:res.data.order.feeplanId,
      ...
      get_detail(row) {
        if (row.type === 1) {
          ...
          this.$router.push({path: '/sys/upload',query: {orderId: this.orderId, customerId: this.customerId}})
        }
      }
