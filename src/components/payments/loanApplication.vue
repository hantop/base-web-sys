<template>
  <div>
    ...
    <div class="g-listpage__style" v-if="$route.name === 'loanApplication'">
          ...
          <div>
            <div class="search-group">
              ...
              <div class="right">
                ...
                <!--</el-option>-->
                <!--</el-select>-->
                <el-input class=" search-btn" v-model="parameterTemp.enterpriseName"  placeholder="企业名称/借款人姓名"  clearable>
                </el-input>
            ...
            <el-table
              ...
              <el-table-column
                prop="fullMarkTime"
                label="满标时间"
                :formatter="(row) => $formatDate(row.fullMarkTime, 'yyyy-MM-dd')"
              >
              </el-table-column>
        ...
        <el-tab-pane label="已申请放款项目" name="second" >
          <div class="search-group">
            ...
            <div class="right">
              ...
              <!--</el-option>-->
              <!--</el-select>-->
              <el-input class=" search-btn" v-model="parameter2Temp.enterpriseName"  placeholder="企业名称/借款人姓名"  clearable>
              </el-input>
...
<script>
  ...
  export default {
    ...
    mounted () {
      if (this.$route.name === 'loanApplication') {
        this.init()
        this.init2()
      }
    },
