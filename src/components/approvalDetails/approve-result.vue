  ...
  <div>
    <el-form :model="ruleForm2" status-icon ref="ruleForm2" label-width="140px" class="demo-ruleForm">
      ...
      <template v-if="ruleForm2.state === 'PASS'">
        <el-form-item label="拟批金额(元)" prop="projectAmount" :rules='$rules.requiredInputNumber'>
        ...
        <template v-else>
          ...
          <el-form-item label="管理费率" prop="carCategory">
            <div class="box">
  ...
  export default {
    data () {
      return {
        ...
        option: [{value: '默认方案', id: 1}, {value: '管理费方案', id: 2}]
      }
    },
    methods: {
      submitForm () {
