			...
			<div class='common-group'>
				<el-form label-position='top' :model='corporationInfo' ref='corporationInfo'>
					...
					<el-row>
						...
						<el-col :span="8">
							<el-form-item label='电话/手机号码' :rules='rules.phoneNumberRule' prop='legalPhone'>
					...
					<el-row>
						<el-col :span="8">
							<el-form-item label='实际控制人信息'>
								<el-checkbox v-model="isSame" @change="setSame" :disabled="isDisabled">同法人</el-checkbox>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item label='实际控制人姓名' :rules='rules.realnameRule' prop='controllerName'>
								<el-input v-model='corporationInfo.controllerName' :disabled="isDisabled"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item label='身份证' :rules='rules.idCardRule' prop='controllerCardNum'>
								<el-input v-model='corporationInfo.controllerCardNum' :disabled="isDisabled"></el-input>
							</el-form-item>
						</el-col>		
					</el-row>
					<el-row>
						<el-col :span="8">
							<el-form-item label='电话/手机号码' :rules='rules.phoneNumberRule' prop='controllerPhone'>
								<el-input v-model='corporationInfo.controllerPhone' :disabled="isDisabled"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
