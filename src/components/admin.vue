    ...
    <el-container>
      ...
      <el-main class="admin_main">
        <el-scrollbar style="height:100%" class="admin_mian_scrollbar">
          ...
          <div>
            ...
            <keep-alive>
              <router-view v-if="$route.meta.keepAlive" @upup="change" @refreshList="onRefresList"></router-view>
            </keep-alive>
            <router-view v-if="!$route.meta.keepAlive" @upup="change" @refreshList="onRefresList"></router-view>
          </div>
        </el-scrollbar>
      ...
      <el-dialog  title="修改密码" :visible.sync="dialogFormVisible" @close="dialogClose" >
        <el-form :model="dialogForm" ref="dialogForm">
          <el-form-item label="原 密 码" :label-width="formLabelWidth" prop="password" :rules="rules.passwordRule" style="margin-right: 40px">
            <el-input v-model="dialogForm.password"  type="password" style="margin-right: 40px"></el-input>
          </el-form-item>
          <el-form-item label="新 密 码" :label-width="formLabelWidth" prop="newPassword" :rules="rules.passwordRule" style="margin-right: 40px">
            <el-input v-model="dialogForm.newPassword"  type="password" style="margin-right: 40px"></el-input>
          </el-form-item>
          <el-form-item label="确认密码" :label-width="formLabelWidth" prop="newPassword1" :rules="rules.passwordRule" style="margin-right: 40px">
            <el-input v-model="dialogForm.newPassword1"  type="password" style="margin-right: 40px"></el-input>
          </el-form-item>
        </el-form>
