<template>
  <div>
    ...
    <div class="g-listpage__style" v-if="$route.name === 'projectArchiveManage'">
      <el-tabs v-model="activeName">
        <el-tab-pane label="待审核回款申请" name="first" >
          <div>
            <div class="search-group">
              ...
              <div class="right">
                <el-input class=" search-btn" v-model="parameterTemp.enterpriseName"  placeholder="企业名称/借款人姓名/身份证/手机"  clearable>
                </el-input>
        ...
        <el-tab-pane label="已审核回款申请" name="second" >
          <div class="search-group">
            ...
            <div class="right">
              <el-input class=" search-btn" v-model="parameter2Temp.enterpriseName"  placeholder="企业名称/借款人姓名/身份证/手机"  clearable>
              </el-input>
...
<script>
  ...
  export default {
    ...
    mounted () {
      if (this.$route.name === 'projectArchiveManage') {
        this.init()
        this.init2()
      }
    },
